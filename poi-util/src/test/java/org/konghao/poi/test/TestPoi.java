...
public class TestPoi {
	...
	public void testObj2Xls() {
		...
		ExcelUtil.getInstance().exportObj2ExcelByTemplate(new HashMap<String,String>(),"/excel/user.xls","d:/test/poi/tus.xls", users, User.class, true);
	}
